...
export default function EndpointDoc({
  ...
  return (
    <div className="w-full max-w-2xl py-6 px-4 lg:px-6 space-y-6 select-text">
      {/* Compact 3 Pillars Pipeline Switcher */}
